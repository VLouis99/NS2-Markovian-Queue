...
set onoff [new Application/Traffic/Exponential]
$onoff attach-agent $udp



# Onoff Traffic 

$onoff set burst_time_ 0.5  # during the ON period
$onoff set idle_time_ 0.5 # during the OFF period
$onoff set packetSize_ 1024
$onoff set rate_ [expr $lambda* [$onoff set packetSize_] *8.0 * 	([$onoff set burst_time_]+[$onoff set idle_time_]) /[$onoff set burst_time_]] # rates are in bits per sec so *8

$ns at 0.01 "$onoff start" 
# $ns at 10000.00 "$onoff stop" # no need to stop
